...
@Slf4j
public class BeaconQueryServiceApacheHttp extends BeaconQueryService{
     ...
     */
    public BeaconQueryServiceApacheHttp(String siteUrl, String proxyUrl, String proxyPort, BeaconQuery query) {
        ...
        if (proxyUrl != null && proxyPort != null) {
            ...
            httpClient = HttpClients.custom()
                    ...
                    .setDefaultHeaders(Collections.singletonList(
                            new BasicHeader("Proxy-Authorization", "ApiKey lensbeacon-connect.lensbeaconde.broker.bbmri.samply.de 6bcae932d8bd44fb8af5")))
                    .build();
        } else
